...
导航：[根 README](../README.md) · [Context 与信任边界](context-and-trust-boundary.md) · [Adapter 合同](adapter-contracts.md) · [架构边界](architecture/README.md) · [Release 边界](release-process.md)
