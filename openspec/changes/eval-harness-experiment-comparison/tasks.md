...
- [x] 3.1 先通过 local-first/provider adapter contract 锁定 provider degraded、secret-shaped error redaction 和大 payload evidence ref，再完成 experiment/comparison evidence fan-out。
