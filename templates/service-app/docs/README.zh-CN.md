...
- 核心 `agent_harness` 公共 seam 见本仓库的[架构边界](../../../docs/architecture/README.zh-CN.md)、[框架定位与能力对照说明](../../../docs/framework-positioning.zh-CN.md)、[扩展指南](../../../docs/extension-guide.zh-CN.md)、[adapter 合同](../../../docs/adapter-contracts.zh-CN.md)、[context 与信任边界](../../../docs/context-and-trust-boundary.zh-CN.md)、[安全策略](../../../docs/security-policy.zh-CN.md)、[eval/observability 闭环](../../../docs/eval-observability-loop.zh-CN.md)、[release 边界](../../../docs/release-process.zh-CN.md) 与 [ADR](../../../docs/adr/0001-p0-service-boundaries.zh-CN.md)。
