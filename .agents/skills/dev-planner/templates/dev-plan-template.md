...
| 项目 | 状态 | 证据 / 下一步 |
|------|------|---------------|
| 总体状态 | [未开始 / 进行中 / 已完成 / 需返工] | [整体进展] |
| 当前 Phase | [Phase N: 名称 / 待启动 / 进行中 / 验收中] | [下一步动作] |
| 已完成 Phase | [Phase 0-N / 无] | [提交、验证或审查记录] |
| 当前阻塞项 | [无 / 阻塞项] | [需要什么才能继续] |
| 当前建议下一步 | [具体动作] | [建议使用哪个 Skill / Phase] |

## 剩余工作

### 立即下一步

- [具体到可以启动 dev-builder 或 OpenSpec propose 的动作]
...
- [从 Product-Spec / API-Contract / Design-Brief / OpenSpec 中抽取仍未满足的关键验收]
...
7. **Phase 顺序**：
   ...
   - 不违反依赖关系。
8. **当前进度 / 剩余工作 / 风险**：
   - 这三块保持固定表格或固定小节，Phase 完成、阻塞、返工或 OpenSpec 状态变化时同步更新。
